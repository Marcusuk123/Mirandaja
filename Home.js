    ...
    <main className="min-h-screen bg-[#fdfaf6] text-[#3b2f2f] px-6 py-12">
      <section className="max-w-6xl mx-auto">
        ...
        <div className="flex justify-center mb-10">
          <img
            src="https://upload.wikimedia.org/wikipedia/commons/thumb/3/36/Grapes_icon.svg/512px-Grapes_icon.svg.png"
            alt="Mirandaja logo"
        ...
        <section className="mb-20">
          ...
          <form className="max-w-xl mx-auto grid gap-4">
            ...
            <textarea
              ...
              className="border p-2 rounded"
            ></textarea>
            <button className="bg-[#3b2f2f] text-white px-4 py-2 rounded hover:bg-[#5b4747]">
              Enviar / Send
            </button>
          </form>
        </section>
